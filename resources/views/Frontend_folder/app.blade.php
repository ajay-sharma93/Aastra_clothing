                                ...
                                <div class="aa-language">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                            <li><a href="#"><img src="assets/img/flag/french.jpg"
                                                        alt="">FRENCH</a></li>
                                            <li><a href="#"><img src="assets/img/flag/english.jpg"
                                                        alt="">ENGLISH</a></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <ul class="aa-testimonial-slider">
                            ...
                            <li>
                                <div class="aa-testimonial-single">
                                    <img class="aa-testimonial-img" src="assets/img/testimonial-img-2.jpg"
                                        alt="testimonial img">
                            ...
                            <li>
                                <div class="aa-testimonial-single">
                                    <img class="aa-testimonial-img" src="assets/img/testimonial-img-1.jpg"
                                        alt="testimonial img">
                                    <span class="fa fa-quote-left aa-testimonial-quote"></span>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt distinctio omnis
                                        possimus, facere, quidem qui!consectetur adipisicing elit. Sunt distinctio omnis
                            ...
                            <li>
                                <div class="aa-testimonial-single">
                                    <img class="aa-testimonial-img" src="assets/img/testimonial-img-3.jpg"
                                        alt="testimonial img">
                                    <span class="fa fa-quote-left aa-testimonial-quote"></span>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt distinctio omnis
                                        possimus, facere, quidem qui!consectetur adipisicing elit. Sunt distinctio omnis
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <form class="aa-login-form" action="{{ route('login') }}" method="GET">
                        @csrf
